    ...
    <div>
      ...
      <div className={`container mx-auto `}>
        <motion.div
          ...
          className="box-border flex flex-col shrink-0 px-5  w-screen text-black bg-white min-h-[530px] ml-[calc(50%_-_50vw)] max-sm:pb-10"
        >
                  ...
                  <div className="flex gap-5 max-md:flex-col max-md:gap-0 max-md:">
                    <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
                      <div className="box-border relative pt-44 pb-40 h-full">
                        ...
                        >
                          Transforming the reverse supply chain through our
                          solutions
                        </h2>
                      </div>
                    </div>
