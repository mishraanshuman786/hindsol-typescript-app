...
function CareerRegistrationhtmlhtmlForm() {
  return (
    <div>
      ...
      {/* Registration Form */}
      <div className="mx-20 border border-blue-500 rounded-lg shadow-md p-6 mt-6 md:mx-64 my-10">
...
export default CareerRegistrationhtmlhtmlForm;
