        ...
        {reviews.map((element, index) => {
          ...
          <div key={index} className="second h-[530px] bg-orange-300  text-black rounded-xl">
            ...
            <div className="flex flex-col justify-between items-center gap-4 p-4">
              <p className="font-semibold text- text-gray-800">{element.name}</p>
              ...
              <p className="description font-semibold text-center text-md text-gray-600 max-w-96">{element.description}</p>
